...
export class FrontalPointProjection3DModel implements PointProjection3DModel {
    position: Vector3;
    projection: Mesh;
    line: Line;
    label: LabelModel;
    ...
    constructor(position: Vector3, label: string) {
        ...
        let linePoints = [];
        linePoints.push(new Vector3(0, this.position.y, this.position.z));
        ...
        this.projection.rotation.z = Math.PI / 2;
    }
}